window.AESTHETIC_CONSTANTS = {
    ...
    STEPS: {
        ...
        PAPILLA: ["1点目:右乳頭(犬-側)","2点目:右乳頭(側-中)","3点目:正中乳頭","4点目:左乳頭(中-側)","5点目:左乳頭(側-犬)","完了しました。"],
        ARC: ["1点目: 上顎右側の切縁","2点目: 上顎中切歯の切縁","3点目: 上顎左側の切縁","4点目: 右側の下唇上縁","5点目: 中央の下唇上縁","6点目: 左側の下唇上縁","完了しました。スマイルアークを確認してください。"],
        CORRIDOR: ["1点目: 右側の口角端","2点目: 右側の歯列最外周（小臼歯）","3点目: 左側の歯列最外周","4点目: 左側の口角端","完了しました。バッカルコリドー率をご確認ください。"],
