window.AESTHETIC_CONSTANTS = {
    ...
    STEPS: {
        ...
        PROPORTION: ["1点目：ヘアライン（不明な場合は額の最上部、または画像端でOK）","2点目：眉間","3点目：瞳孔ライン","4点目：鼻下","5点目：口唇","6点目：オトガイ","完了しました"],
        ...
        WL: ["右中切歯: 上端","右中切歯: 下端","右中切歯: 近心(左端)","右中切歯: 遠心(右端)","左中切歯: 上端","左中切歯: 下端","左中切歯: 近心(右端)","左中切歯: 遠心(左端)","完了しました。"],
